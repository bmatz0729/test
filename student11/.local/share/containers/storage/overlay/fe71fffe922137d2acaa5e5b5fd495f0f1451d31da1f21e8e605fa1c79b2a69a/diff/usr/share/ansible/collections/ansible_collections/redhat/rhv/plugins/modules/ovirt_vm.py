...
options:
    ...
    operating_system:
        description:
            ...
            - Default value is set by oVirt/RHV engine.
            - Use the M(redhat.rhv.ovirt_vm_os_info) module to obtain the current list.
        type: str
    boot_devices:
        description:
        ...
        suboptions:
            ...
            mac_address:
                description:
                    ...
                    To manage NICs of the VM in more depth please use M(redhat.rhv.ovirt_nic) module instead."
    disks:
        description:
        ...
        suboptions:
            ...
            activate:
                description:
                    ...
                    To manage disks of the VM in more depth please use M(redhat.rhv.ovirt_disk) module instead."
                type: bool
    sysprep:
        description:
...
extends_documentation_fragment: redhat.rhv.ovirt
'''
...
from ansible_collections.redhat.rhv.plugins.module_utils.ovirt import (
    BaseModule,
    check_params,
    check_sdk,
    convert_to_bytes,
